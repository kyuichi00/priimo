                    ...
                    <div class="text-center">
                        <div class="ibox-content no-padding border-left-right col-lg-4">
                            <?php if($user['user_avatar'] == null): ?>
                                <img src="<?php echo e(asset('user_profile_pic/user.jpg')); ?>" class="img-rounded" alt="" width="250">
                            <?php else: ?>
                                <img src="<?php echo e(asset('user_profile_pic/'.$user['user_avatar'])); ?>" class="img-rounded" alt="Cinque Terre" width="250">
                            <?php endif; ?>
                        </div>
