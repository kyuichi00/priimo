                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/login')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('user_email') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="user_email" type="email" class="form-control" name="user_email" value="<?php echo e(old('user_email')); ?>" required autofocus>
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                ...
                                <a href="<?php echo e(url('/register')); ?>" class="btn btn-warning">
                                    Register
                                </a>
